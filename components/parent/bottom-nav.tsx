...
export function BottomNav() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 flex h-20 items-center justify-around border-t bg-background/95 pb-safe backdrop-blur-md transition-all duration-300 md:h-24 lg:justify-center">
