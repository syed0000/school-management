        ...
        <CardContent className="p-6">
          ...
          {isEditingPhoto && (
            <div className="mt-6 p-4 bg-background rounded-xl border animate-in fade-in slide-in-from-top-4">
              <h3 className="text-sm font-semibold mb-3">Update Profile Photo</h3>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card className="border-0 shadow-sm sm:border">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div className="space-y-1">
                <span className="text-muted-foreground">Govt. Teacher ID</span>
                <p className="font-medium">{teacher.governmentTeacherId || "-"}</p>
              </div>
              <div className="space-y-1">
                <span className="text-muted-foreground">Past Experience</span>
                <p className="font-medium">{teacher.pastExperience?.totalExperience || "0"} Years</p>
              </div>
